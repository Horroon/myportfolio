...
const Items: Array<ItemFace> = [
    { title: "About Me", iconClass: "fa fa-users", desc: "Social connection is important as it improves our physical, emotional, and mental health.", pathurl:'/' },
    ...
    { title: "Contact", iconClass: "fa fa-address-book", desc: "If you live to be 100, I hope I live to be 100 minus 1 day, so I never have to live without you.",pathurl:'/' },
