...
export const Photo: React.FC<photoFace> = ({ img, desc }): JSX.Element => {
  return (
    <div className="col-lg-3 phto-itm-1 phto-itm w3-container w3-center w3-animate-bottom">
      <div className="photo-img-dv">
        <img src={img} className="pic-dv" draggable={false} />
      </div>
      <div>
        <p>{desc}</p>
      </div>
